...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Oysh0VX3iPjP/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Hogi5JgDXKNY/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: thwo51VmiAJO/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mCmih)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tWk2)}
                role={"img"}
              />
            ),

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Tdr0_KJBIQvv/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: jLMzU1Vrbwnc/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Hogi5JgDXKNY/icon
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__n7R22)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__tyNgF)}
              role={"img"}
            />
          ),
